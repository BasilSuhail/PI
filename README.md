...
Immich on pi2 at `https://photos.<tailnet>.ts.net`. A timeline, albums,
...
The Postgres cannot be pi's. Immich needs the VectorChord extension compiled
...
times longer and nothing else on pi2 notices. That single number is the knob
