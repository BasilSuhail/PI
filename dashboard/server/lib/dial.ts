 ...
 * one of the boards it monitors, and after a power cycle pi2 could reach every
 ...
 * everyone else:
 *
 *     pi2 $ curl http://<pi2-tailscale-ip>:61208/api/4/cpu   ->  000
 *     pi2 $ curl http://127.0.0.1:61208/api/4/cpu      ->  200
 *
